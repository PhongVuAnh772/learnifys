...
type ClassroomData = Record<string, any>; // Dữ liệu truyền vào cho insert/upsert/update

// Hàm chèn một bản ghi vào bảng `classrooms`
const insertClassroom = async (data: ClassroomData) => {
...
// Hàm chèn nhiều bản ghi vào bảng `classrooms`
const insertManyClassrooms = async (dataArray: ClassroomData[]) => {
    const { data: insertedData, error } = await supabase
        .from('classrooms')
...
const upsertClassrooms = async (dataArray: ClassroomData[]) => {
...
const updateClassroom = async (data: ClassroomData, filters: Record<string, any>) => {
    let query = supabase
        .from('classrooms')
...
export { insertClassroom, insertManyClassrooms, upsertClassrooms, updateClassroom };
