...
const CreateVideoRoomScreen = () => {
  ...
  const handleCreateRoom = async () => {
    ...
    try {
      ...
      router.push("/teacher-action/video-room"); // Điều hướng về danh sách phòng video sau khi tạo
    } catch (error) {
      console.error("Lỗi tạo phòng video:", error);
      Alert.alert("Lỗi", "Có lỗi xảy ra trong quá trình tạo phòng video");
    }
  };
