...
class teacherController {
  ...
  getQuestionByTeacher = async (req, res) => {
    try {
      ...
      let listData = await questionService.getQuestions({
        typeId,
        level,
        search,
        teacherId: userId,
  ...
  createNewQuestionByTeacher = async (req, res) => {
    try {
      ...
      let checkCreate = await questionService.createNewQuestion({
        teacherId: userId,
        questionPrompt,
        options,
        answer,
  ...
  updateOneExamByTeacher = async (req, res) => {
    try {
      ...
      let checkUpdate = await examService.updateOneExam({
        examId,
        teacherId: userId,
        name,
        description,
  ...
  updateOneExamInvigilatorByTeacher = async (req, res) => {
    try {
      ...
      let checkIsExist = await examInvigilatorService.checkIsExist({
        examId,
        invigilatorId,
      });
      if (checkIsExist) {
      ...
      let checkUpdate = await examInvigilatorService.updateInvigilator({
        examId,
        invigilatorId,
      });
      if (!checkUpdate) {
  ...
  getListClassByTeacher = async (req, res) => {
    try {
      ...
      let data = await classService.getListClassByTeacherId({
        teacherId: userId,
        search,
      });
  ...
  postNewDocumentsByTeacher = async (req, res) => {
    try {
      ...
      let checkDelete = await documentService.postDocuments({
        classId,
        files: req.files,
      });
      if (!checkDelete) {
  ...
  deleteOneDocumentByDocumentId = async (req, res) => {
    try {
      ...
      let checkDeleteDocument =
        await documentService.deleteOneDocumentByDocumentId({
          documentId,
          file,
        });
  ...
  deleteStudentOfClass = async (req, res) => {
    try {
      ...
      let checkDelete = await studentClassService.deleteOneStudentOfClass({
        studentId,
        classId,
      });
      if (!checkDelete) {
  ...
  addNewStudentToClass = async (req, res) => {
    try {
      ...
      let checkStudentInClass = await studentClassService.isStudentInClass({
        studentId,
        classId,
      });
      ...
      let checkCreate = await studentClassService.addNewStudentToClass({
        studentId,
        classId,
      });
      if (!checkCreate) {
  ...
  getListExamsOfInvigilatorByTeacherId = async (req, res) => {
    try {
      ...
      let data =
        await examInvigilatorService.getLigetListExamsOfInvigilatorByInvigilatorId(
  ...
  createRoomVideoByTeacher = async (req, res) => {
    try {
      ...
      let checkUpdate = await roomVideoService.createNewRoom({
        examId,
        roomId,
        roomToken,
      });
